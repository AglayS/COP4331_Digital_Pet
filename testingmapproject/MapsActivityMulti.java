...
public class MapsActivityMulti extends FragmentActivity implements OnMapReadyCallback, SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_multi);
        ...
        // get breed2
        String breed2 = getIntent().getStringExtra("theBreed2");
        ...
        myPet2 = findViewById(R.id.img_pet2);

        // set pet image 1
        String currentBreed = myUser.getBreed();
        Resources res = getResources();
        pet_string2 = String.format(currentBreed + "_walk"); // breed + animation
        myPet2.setImageResource(res.getIdentifier(pet_string2, "drawable", getPackageName()));

        // set pet image 2
        String currentBreed2 = breed2;
        Resources res2 = getResources();
        pet_string = String.format(currentBreed2 + "_walk"); // breed + animation
        myPet.setImageResource(res2.getIdentifier(pet_string, "drawable", getPackageName()));
        ...
        myTask.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mySupMap.getMapAsync(MapsActivityMulti.this);
